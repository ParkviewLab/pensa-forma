...
The specification: fifteen documents complete enough that an implementation
can be built from them alone, three of them with a designed HTML twin beside
them, and a worked example generated from their rules. They stand on their
